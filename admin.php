            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php $_PHP_SELF ?>" class="form-horizontal form-material mx-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input required name="admin_password" value="1aA!1aA!" type="password" placeholder="Enter your password" class="form-control ps-0 form-control-line" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
                        </div>
                    </div>
                    <div class="form-group">
